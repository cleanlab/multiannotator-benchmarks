...
def disagreement():
    ...
    for k in range(num_rounds):
        ...
        for i in range(num_iter):
            ...
            # Train cross validation model
            (model_accuracy1, pred_probs1, pred_probs_test1,) = train_cross_val_model(
                MLPClassifier(max_iter=500),
                X_labeled,
                consensus_labels,
                true_labels_test,
            ...
            (model_accuracy2, pred_probs2, pred_probs_test2,) = train_cross_val_model(
            ...
            (model_accuracy3, pred_probs3, pred_probs_test3,) = train_cross_val_model(
